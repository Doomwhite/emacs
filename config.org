...
- [[#important-programs-to-load-first][Important Programs To Load First]]
  ...
  - [[#setting-the-keybindings-functions][Setting the keybindings functions]]
  - [[#setting-the-keybindings][Setting the keybindings]]
...
#+begin_src emacs-lisp
  ...
  (add-hook 'after-make-frame-functions #'update-scroll-keybinding)
...
Hook required to work in daemon/client settings
#+begin_src emacs-lisp
